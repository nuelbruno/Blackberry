...
Container {
    ...
    property variant stationData: new Array()
    ...
    Container {
        ...
        onTouch: {
            if(event.isUp())
            {
                var mStationDetailsPage = mStationDetails.createObject();
                //mStationDetailsPage.stationCode = stationCode;
                mStationDetailsPage.passMyfavouriteData(stationData)
                mNavigationPaneMain.push(mStationDetailsPage);
            }
        }
    }
    attachedObjects: [
