...
Page {
    ...
    titleBar: TitleBar {
        id: addBar
        title: qsTr("Facebook Feed") + Retranslate.onLanguageChanged
    
    }
    function passNewsUniqName(data) {
        console.debug("companyNumber :", data.getArea)
        console.debug("getZoneNo facebook describion :", data.getZoneNo)
           
        titleLable.text = data.getTitle;
        //dateLabel.text = data.getDistance;
        newsDetailLabel.text = data.getArea;
        newsDetaildescribtion.text = data.getZoneNo;
        webViewImage.url ="https://graph.facebook.com/" + data.getStationID+ "/picture";
